...
echo ""
echo "🔥 IMPORTANT: Configure Lightsail Firewall!"
echo "   1. Go to Lightsail Console > Your Instance > Networking"
echo "   2. Add firewall rule: HTTPS (443) - TCP - Anywhere (0.0.0.0/0)"
echo "   3. Keep HTTP (80) open for certificate renewal"
echo ""
...
echo ""
echo "🎯 Architecture: Browser ──HTTPS──▶ Flask (Direct SSL, no proxy)"
